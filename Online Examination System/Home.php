...
<body>
  ...
  <div id="jinu" >
    ...
    <a href="Profile.php"class="btn btn-outline-dark"id="a4">Profile</a>
  ...
  <nav class="zone  sticky" id="nav-bar" hidden>
      <ul class="main-nav">
          ...
          <li><a href="Exam.php"id="navitem">Quiz Exams</a></li>
          <li class="push"><a href="index.php" id="navitem">Log Out</a></li>
     </ul>
  </nav>
